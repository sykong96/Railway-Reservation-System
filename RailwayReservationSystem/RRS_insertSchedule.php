...
if(isset($_POST['done'])){
	...
	$q = "INSERT INTO `train_schedule`(`TrainScheduleDate`, `TrainScheduleDeparture`, `TrainScheduleArrival`, `TrainScheduleDepartureTime`, `TrainScheduleArrivalTime`) VALUES 
	      ('$TrainScheduleDate', '$TrainScheduleDeparture', '$TrainScheduleArrival', '$TrainScheduleDepartureTime' , '$TrainScheduleArrivalTime' )";
	$query = mysqli_query($conn,$q);
    
    echo "<script> alert('Added Successfully!');window.location='RRS_viewSchedule.php' </script>";	
	    ...
	    <form method="post">
		  <br><br><div class="card">
			...
			<div class="card-header bg-dark">
			   <h1 class="text-white text-center"> Create Schedule </h1>
			</div><br>
