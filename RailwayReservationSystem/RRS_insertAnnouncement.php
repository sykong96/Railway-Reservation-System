...
if(isset($_POST['done'])){
	...
	$q = "INSERT INTO `announcement`(`AnnouncementTitle`, `AnnouncementDetails`) VALUES 
	      ('$AnnouncementTitle', '$AnnouncementDetails')";
	$query = mysqli_query($conn,$q);
    
    echo "<script> alert('Added Successfully!');window.location='RRS_viewAnnouncement.php' </script>";	
...
<html>
<head>
   <title>RRS - Add Announcement</title>
	    ...
	    <form method="post">
		  <br><br><div class="card">
			...
			<div class="card-header bg-dark">
			   <h1 class="text-white text-center"> Create Announcement </h1>
			</div><br>
